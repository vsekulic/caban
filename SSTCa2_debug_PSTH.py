...
'''
    ...
    for group, mice in mice_per_group.items():
        ...
        for m in range(len(mice)):
            ...
            if mapping_type == 'full':
                ...
                for i in range(len(df_mapping)):
                    ...
                    try:
                        ...
                        continue
                C = s.S[indeces,:]
            tot_cells[group][mouse] = C.shape[0]
            ...
            frac_tots[group][mouse] = len(sig_cells_mouse) / C.shape[0]
    ...
    for group in ['hM3D', 'hM4D', 'mCherry']:
        ...
        plt.plot(group_mean, color='b', lw=1)
        plt.fill_between(range(save_len), group_mean - group_shaded, group_mean + group_shaded, alpha=0.2)
